...
router.post('/predict', async (req, res) => {
  ...
  // If shipmentId provided, pull from store
  if (shipmentId) {
...
router.post('/route', async (req, res) => {
  const { shipmentId, origin, destination, cargo, issues, priority } = req.body;

  let routeData = { origin, destination, cargo, issues, priority };
